...
function showPatientError(input, message) {
...
function validatePatientForm() {
    ...
    if (name === "") {
        ...
        showPatientError(patientNameInput, "يرجى إدخال اسم المريض");
    ...
    if (phone === "") {
        ...
        showPatientError(patientPhoneInput, "يرجى إدخال رقم الهاتف");
    ...
    if (phone !== "" && !/^01[0125][0-9]{8}$/.test(phone)) {
        ...
        showPatientError(patientPhoneInput, "رقم الهاتف غير صحيح");
